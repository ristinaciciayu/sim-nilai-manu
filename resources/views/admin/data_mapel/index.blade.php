...
<div class="container">
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-header d-flex justify-content-between align-items-center">
            <a href="{{ route('admin.data_mapel.create') }}" class="btn btn-primary">
                <i class="bi bi-plus-circle"></i> Tambah Mapel
            </a>

            <form action="{{ route('admin.data_mapel.index') }}" method="GET" class="d-flex">
                <input type="text" name="search" class="form-control me-2" 
                       placeholder="Cari berdasarkan nama mapel" value="{{ request('search') }}">
                <button type="submit" class="btn btn-outline-primary">Cari</button>
            </form>
        </div>

        <!-- Body Card: Tabel Mapel -->
        <div class="card-body p-0">
            <table class="table table-striped table-hover table-bordered align-middle mb-0">
                ...
                <tbody>
                    @forelse($mapels as $mapel)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('admin.data_mapel.edit', $mapel->id) }}" class="btn btn-sm btn-warning">
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="text-center">Data mapel tidak ditemukan.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
